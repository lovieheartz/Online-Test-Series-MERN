...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      >
        <div className={`h-1 rounded bg-blue-900 transition-all duration-300 ${isOpen ? "rotate-45 translate-y-[10px]" : ""}`}></div>
        <div className={`h-1 rounded bg-blue-900 transition-all duration-300 ${isOpen ? "opacity-0" : ""}`}></div>
        <div className={`h-1 rounded bg-blue-900 transition-all duration-300 ${isOpen ? "-rotate-45 -translate-y-[10px]" : ""}`}></div>
      </div>
          ...
          <ul className="flex flex-col items-start space-y-5 text-lg font-semibold">
            ...
            <li className="w-full">
              ...
              >
                <span>Faculty</span>
                <svg
                  className={`w-4 h-4 ml-2 transition-transform duration-300 ${facultyDropdownOpen ? "rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  viewBox="0 0 24 24"
            ...
            <li className="w-full">
              ...
              >
                <span>Admin</span>
                <svg
                  className={`w-4 h-4 ml-2 transition-transform duration-300 ${adminDropdownOpen ? "rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  viewBox="0 0 24 24"
